...
def sim_pro(gp, sp, vlist, pGo_list=[0, .2, .4, .6, .8, 1], mfx=simfx.sim_radd, ntrials=1500, tb=.560, task='ssProBSL', visual=False):
	...
	for i,v in enumerate(vlist):
		...
		out=ss.set_model(gParams=gp, sParams=sp, mfx=mfx, ntrials=ntrials, timebound=tb, visual=visual, task=task) 
